 ...
 *
 */
public class TS_13159_browseTheArtifactsInArtifactsPage extends AbstractFrameworkTest {
  
  /**
   * Test case is for browsing the Artifact in 'Type to filter artifacts by text or by ID' search box of Artifact page 
   ...
   */
  @Test
  public void tcs_13159_browseTheArtifactsInArtifactsPage() throws InvalidKeyException{
   ...
   //Select the project area.
    ...
    //Click on Artifacts All hyper link.
