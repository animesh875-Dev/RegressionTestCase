 ...
 *
 */
public class TS_13424_browseTheArtifactsInsideTheModule extends AbstractFrameworkTest {
  /**
   * Test case is for browsing the Artifact inside a module in 'Type to filter artifacts by text or by ID' search box of Artifact page 
   * and Verifies all content (summary, project, created on, created by, type and status) of all searched IDs or text 
   * is matching with the previous stored values.
   * 
   * @throws InvalidKeyException if the property doesn't exist.
   */
  @Test
  public void tcs_13424_browseTheArtifactsInsideTheModule() throws InvalidKeyException{
    ...
    Reporter.logPass(ArtifactTypes.MODULES.toString() + " hyper link of Artifacts opened successfully.");
