 ...
 * @author BBO1KOR
 */
public class TS_17522_deliverTheChangeSetUsingExpressDeliveryOptionInCMEnabledProjectArea
    extends AbstractFrameworkTest {

  /**
   * This test case for Deliver the change set using 'Express' Delivery option
   *
   * @throws Throwable is use to handle any kind of exception.
   */
  @Test
  public void tcs_17522_deliverTheChangeSetUsingExpressDeliveryOptionInCMEnabledProjectArea() throws Throwable {
    ...
    getJazzPageFactory().getRMDashBoardPage().chooseChangeSetDeliveryOption("Express");
    Reporter.logPass("Choose the change set delivery option as 'Express'.");
