 ...
 * @author BBO1KOR
 */
public class TS_17511_deliverTheChangeSetUsingStandardDeliveryOptionInCMEnabledProjectArea
    extends AbstractFrameworkTest {

  /**
   * This test case for Deliver the change set using 'Standard' Delivery option.
   *
   * @throws Throwable is use to handle any kind of exception.
   */
  @Test
  public void tcs_17511_deliverTheChangeSetUsingStandardDeliveryOptionInCMEnabledProjectArea() throws Throwable {
    ...
    getJazzPageFactory().getRMDashBoardPage().chooseChangeSetDeliveryOption("Standard");
    Reporter.logPass("Choose the change set delivery option as 'Standard'.");
