 ...
 *
 */
public class TS_39822_createAJrsCurrentDataReportWithTraceblityIncluded_DNG_RQM_RTC extends AbstractFrameworkTest {
   ...
   */
  @Test
  public void tcs_39822_createAJrsCurrentDataReportWithTraceblityIncluded_DNG_RQM_RTC() throws Throwable {
    ...
    String requirement_management = testDataRule.getConfigData("REQUIREMENTS_MANAGEMENT");
    ...
    String search_ID = testDataRule.getConfigData("SEARCH_ID");
    String ID_type_value = testDataRule.getConfigData("ID_TYPE_VALUE");
    String ID_value = testDataRule.getConfigData("ID_VALUE");
    ...
    String no_of_records = testDataRule.getConfigData("NO_OF_RECORDS");
    String expected_module_id = testDataRule.getConfigData("EXPECTED_MODULE_ID");
    ...
    String expected_work_item_id = testDataRule.getConfigData("EXPECTED_WI_ID");
    String folder_name = testDataRule.getConfigData("FOLDER_NAME");
    boolean flag = false;

    Map<String, String> columnValue = new LinkedHashMap<>();
    ...
    //  getJazzPageFactory().getJRSBuildNewReportPage().waitForSecs(2);
     ...
     // getJazzPageFactory().getJRSBuildNewReportPage().waitForSecs(10);
      ...
      getJazzPageFactory().getJRSBuildNewReportPage().chooseAnArtifact(requirement_management, child_artifact);
    ...
    //  getJazzPageFactory().getJRSBuildNewReportPage().waitForSecs(10);
      ...
      /* Creating relationship of Collection or Module --> All link types --> Requirement --> Validated by Test Case --> 
       * Test Case --> All link types 1 --> Work Item */
     ...
     // getJazzPageFactory().getJRSBuildNewReportPage().waitForSecs(10);
      ...
      getJazzPageFactory().getJRSBuildNewReportPage().setConditionAttributesOfvalue("Collection or Module [Type: Collection or Module]");
      Reporter.logPass("Clicked on condition attribute value option ");
      getJazzPageFactory().getJRSBuildNewReportPage().clickOnRadiobutton(search_ID);
      getJazzPageFactory().getJRSBuildNewReportPage().setConditionType(ID_type_value);
      getJazzPageFactory().getJRSBuildNewReportPage().setConditionInTextBox(ID_value);
      getJazzPageFactory().getJRSBuildNewReportPage().clickOnJazzSpanButtons("Add and Close");
      ...
      getJazzPageFactory().getJRSBuildNewReportPage().setTagValue("Testing");
     ...
     // getJazzPageFactory().getJRSBuildNewReportPage().waitForSecs(10);
      ...
      getJazzPageFactory().getJRSBuildNewReportPage().verifyTotalNoOfRecords(no_of_records);
      columnValue.put("columnValue1", expected_module_id);
      columnValue.put("columnValue2", expected_requirement_id);
      columnValue.put("columnValue3", expected_test_case_id);
      columnValue.put("columnValue4", expected_work_item_id);
      
      Boolean finalResult = getJazzPageFactory().getJRSBuildNewReportPage().checkArtifacetRelationshipsAutoCreated(columnValue);
      String finalValue ="false" ;
      if (finalResult) {
        finalValue = "true";
      }
      TestAcceptanceMessage Ta = getJazzPageFactory().getJRSBuildNewReportPageVerification().verifyCheckArtifacetRelationshipsAutoCreated(columnValue, finalValue);
