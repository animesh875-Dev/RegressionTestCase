...
*//**
 * This test case use to create a work item under the plan.
 *//*
public class TS_14368_createWiFromPlanViewUsingAddWorkItem extends AbstractFrameworkTest {

  *//**
   * This test case creating new Work Items from plan view using Add work item right side button and Fill Summary, Field
   * Against, Owned by and check created Work Item then validating work item created in plan.
   *
   * @throws Throwable use to handle any kind of exception
   *//*
  @Test
  public void TCS_14368_createWiFromPlanViewUsingAddWorkItem() throws Throwable {
    ...
    getJazzPageFactory().getCCMPlanPage().addWorkItemInsidePlan(workItemType);
    getJazzPageFactory().getCCMAllProjectsPage().waitForSecs(2);
    Reporter.logPass("Story" + " Work item selected successfully.");

    // clickon sub button Edit Work Item
