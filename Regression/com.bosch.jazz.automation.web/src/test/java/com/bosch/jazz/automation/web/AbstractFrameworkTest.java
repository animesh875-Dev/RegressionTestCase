 ...
 * @author taa6si
 */
public abstract class AbstractFrameworkTest extends AbstractUserCredentialsRequiringTest {
...
//    driverSetup.closeBrowserTasks();
  ...
  protected final JazzPageFactory getJazzPageFactory() {
    return AbstractFrameworkTest.jazzPageFactory;
  }
